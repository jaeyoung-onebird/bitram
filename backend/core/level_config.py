...
LEVEL_CONFIG = {
    0: {"name": "석탄", "color": "#78716c", "min_points": 0, "perks": []},
    1: {"name": "아이언", "color": "#a1a1aa", "min_points": 50, "perks": ["닉네임 색상"]},
    2: {"name": "브론즈", "color": "#d97706", "min_points": 200, "perks": ["이미지 업로드"]},
    3: {"name": "실버", "color": "#9ca3af", "min_points": 500, "perks": ["커스텀 뱃지 선택"]},
    4: {"name": "골드", "color": "#eab308", "min_points": 1000, "perks": ["게시글 고정 1개"]},
    5: {"name": "플래티넘", "color": "#06b6d4", "min_points": 2000, "perks": ["DM 무제한"]},
    6: {"name": "사파이어", "color": "#2563eb", "min_points": 5000, "perks": ["전략 마켓 등록"]},
    7: {"name": "루비", "color": "#dc2626", "min_points": 10000, "perks": ["프리미엄 뱃지"]},
    8: {"name": "에메랄드", "color": "#059669", "min_points": 20000, "perks": ["VIP 채팅방"]},
    9: {"name": "다이아몬드", "color": "#8b5cf6", "min_points": 50000, "perks": ["올 액세스"]},
}


def get_level_info(level: int) -> dict:
    """Get level configuration for a given level number."""
    return LEVEL_CONFIG.get(level, LEVEL_CONFIG[0])
...
def get_level_progress(total_points: int, current_level: int) -> dict:
    ...
    current = LEVEL_CONFIG.get(current_level, LEVEL_CONFIG[0])
