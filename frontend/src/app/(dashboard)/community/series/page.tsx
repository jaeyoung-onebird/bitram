              ...
              <div className="p-4 space-y-2">
                ...
                <div className="flex items-center justify-between pt-1">
                  <div className="flex items-center gap-2">
                    {s.user.avatar_url ? (
                      <img src={s.user.avatar_url} alt={s.user.nickname} className="w-5 h-5 rounded-full object-cover" />
                    ) : (
                      <div className="w-5 h-5 rounded-full bg-slate-200 dark:bg-slate-700 flex items-center justify-center">
                        <span className="text-[8px] font-bold text-slate-500 dark:text-slate-400">{s.user.nickname.charAt(0)}</span>
                      </div>
                    )}
                    <span className="text-xs text-slate-600 dark:text-slate-300">{s.user.nickname}</span>
                  </div>
