...
from core.points import compute_level, next_level_info, get_level_perks
...
async def get_my_points(
    ...
    if not up:
        return {
            ...
            "perks": get_level_perks(1),
            **next_level_info(0),
        }

    level_num = compute_level(up.total_points or 0)
    perks = get_level_perks(level_num)
    return {
